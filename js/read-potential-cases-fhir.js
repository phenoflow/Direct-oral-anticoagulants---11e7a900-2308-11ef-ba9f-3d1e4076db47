...
(async () => {
  ...
  await fs.writeFile("direct-oral-anticoagulants-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("direct-oral-anticoagulants-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
